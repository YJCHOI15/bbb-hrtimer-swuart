...
@ GNU C89 (Debian 12.2.0-14+deb12u1) version 12.2.0 (arm-linux-gnueabihf)
...
@ options passed: -mlittle-endian -mapcs -mno-sched-prolog -mfloat-abi=soft -mabi=aapcs-linux -mfpu=vfp -marm -mtls-dialect=gnu -march=armv7-a -O2 -std=gnu90 -p -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -fno-dwarf2-cfi-asm -fno-ipa-sra -fno-delete-null-pointer-checks -fno-allow-store-data-races -fstack-protector-strong -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-strict-overflow -fstack-check=no -fconserve-stack
	.text
